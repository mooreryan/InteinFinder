...
starts at 2 and not at 1.
  ...
  the_2_second_sequence                            2       inbase___seq_440     P                       C             A                   N           C                    412            Pass (T1 C)          Maybe (AN)          Pass (C)                    Pass (At 751)         Pass (At 1162)      Pass          Pass
  the_3_third_sequence                             1       inbase___seq_219     P                       C             H                   N           C                    367            Pass (T1 C)          Pass (HN)           Pass (C)                    Pass (At 483)         Pass (At 849)       Pass          Pass (Strict)
  the_4_fourth_sequence                            2       inbase___seq_440     P                       C             H                   N           C                    407            Pass (T1 C)          Pass (HN)           Pass (C)                    Pass (At 885)         Pass (At 1291)      Pass          Pass (Strict)
